...
def main():
    ...
    parser.add_argument('--script', type=str, required=False, default='seqtrack', help='Name of the train script.')
    parser.add_argument('--config', type=str, required=False, default='seqtrack_b256', help="Name of the config file.")
